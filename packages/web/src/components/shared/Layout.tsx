          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr]">
            <div>
              ...
              <div className="mt-5 flex items-center gap-3">
                ...
                <a href="https://x.com/AiActToolkit" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-400 hover:text-navy hover:border-slate-300 transition-colors" aria-label="X / Twitter">
