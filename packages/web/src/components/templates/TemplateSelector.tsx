    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {TEMPLATES.map((template) => (
        <button
          ...
          className="group rounded-xl border border-gray-200 p-5 text-left transition-all hover:border-eu-blue/30 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-eu-blue focus:ring-offset-2"
        >
          <svg
            className="h-8 w-8 text-eu-blue"
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth={1.5}
            stroke="currentColor"
          ...
          <h3 className="mt-3 text-sm font-semibold text-navy group-hover:text-eu-blue">
            {template.title}
          </h3>
