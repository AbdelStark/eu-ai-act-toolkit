    ...
    <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
      {TEMPLATES.map((template) => (
        <button
          ...
          className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white text-left shadow-soft-sm transition-all duration-300 hover:border-slate-300 hover:shadow-soft-lg hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-eu-blue focus:ring-offset-2"
        >
          {/* Preview snippet */}
